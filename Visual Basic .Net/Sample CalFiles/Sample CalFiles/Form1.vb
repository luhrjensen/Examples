...
Public Class Form1
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ' Grab the CalFileList
        CalFileList.Lines = kClmtr.CalFileList
    End Sub

    Private Sub SelectID_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SelectID.Click
        ' Set the ID
        kClmtr.CalFileID = CalFileID.Value
        ' Get the Name
        CalFileName.Text = kClmtr.CalFileName
    End Sub
End Class
